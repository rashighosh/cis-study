...
fs.writeFileSync('public/intro-voices/companion-intro1.mp3', Buffer.from(audio, 'base64'));
fs.writeFileSync('public/intro-voices/companion-intro-timestamps1.json', JSON.stringify(timestamps, null, 2));
